...
{
    let s=typeof(address)+typeof(distanceFromTown)+typeof(hasNeighbours);
    return s;
}
//Progression 2:
...
{
    var leftover=(totalNoOfSweets-sweetsConsumedByKaren-(sweetsConsumedInNMeters*metersToTravel))/2;
    if(isNaN(leftover))
    {
